...
import ProductOption from '../add-product/ProductOption';
...
const EditProductForm = ({ slug }: SlugProps) => {
        ...
        return (
            <>
                ...
                <div onClick={() => router.back()} className='flex gap-3 items-center cursor-pointer'>
                    <FaArrowLeft />
                    <h1 className='font-open font-[400] text-[1rem] text-[#333333] leading-[22px]'>Edit Product</h1>
                </div>
